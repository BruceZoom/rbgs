...
Module CCASImpl.
  ...
  Variant Task : Type := task (t : tid) (o n : Val).

  Program Definition E : layer_interface :=
  {|
    li_sig := Sig.Plus.omap (ECAS' (Task + Val)) (EReg bool);
    li_lts := tens_lts VCAS' VReg;
    li_init := pair (Idle (inr vInit)) (Idle true);
  |}.
