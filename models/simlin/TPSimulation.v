...
Module TPSimulation.
  ...
  Theorem layer_implementation_TPSimulationSet {L L' : layer_interface} :
    layer_implementation L L' ->
    TPSimulationSet.TPSimulation.layer_implementation
      (to_set_layer_interface L) (to_set_layer_interface L').
  Proof.
    intros [M Hcorrect].
    refine (@TPSimulationSet.TPSimulation.Build_layer_implementation
